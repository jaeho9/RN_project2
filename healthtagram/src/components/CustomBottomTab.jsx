...
const ChattingOn = require('../assets/icons/bottomtab/chatting_on.png');
const ChattionOff = require('../assets/icons/bottomtab/chatting_off.png');
                ...
                state.routes.map((route, index) => {
                    ...
                    const iconFlag = bool => {
                        switch (label) {
                            ...
                            case '채팅':
                                return bool ? ChattingOn : ChattionOff;
                            default:

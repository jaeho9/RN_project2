...
import { SafeAreaView, View, Text, Image, TextInput, StyleSheet, TouchableOpacity, FlatList, Dimensions, NativeModules } from 'react-native';
...
const dummy_data = [
    ...
    },
    {
        ...
        created_date: '12:03PM',
        position: 'right',
        profileImgUlr: require('../assets/icons/plus.png'),
        isOpen: true
    },
    {
        id: 3,
    ...
    },
    {
        id: 4,
        name: '이민구',
        content: '나는 풍자 또 간집에 나온 소라 편의점의 제육볶음이 너무 먹고싶구나ㅎㅎㅎㅎ',
        created_date: '12:03PM',
        position: 'left',
        profileImgUrl: require('../assets/images/dummyProfile.png'),
        isOpen: true
        ...
        <SafeAreaView style={styles.safeAreaViewStyle}>
            <View style={styles.mainContainer}>
                ...
                <View style={styles.chattingScreen}>
                    <FlatList
                        data={dummy_data}
                        renderItem={({ item, index }) => item.position === 'left' ? <LeftBubble data={item} /> : <RightBubble data={item} nextData={dummy_data[index + 1]} />}
            ...
            <View style={{ padding: 16, flexDirection: 'row' }}>
                <TouchableOpacity
                    ...
                    style={{ borderWidth: 1, borderColor: '#EFEFEF', borderRadius: 20, width: 40, height: 40, justifyContent: 'center', alignItems: 'center', marginRight: 8 }}>
                ...
                <View style={{
                    ...
                    <View style={{ padding: 16, flexDirection: 'row' }}>
                        <TouchableOpacity
                            onPress={() => setModalVisible(!modalVisible)}
                            style={{ borderWidth: 1, borderColor: '#EFEFEF', borderRadius: 20, width: 40, height: 40, justifyContent: 'center', alignItems: 'center', marginRight: 8 }}>
                            <Image source={plusIcon} style={{ width: 12, height: 12, transform: [{ rotate: '45deg'}] }} />
                        </TouchableOpacity>
                        <TextInput
                            placeholder='메세지 입력하기'
                            style={{
                    ...
                    <View style={{flexDirection: 'row', gap: 40, marginLeft: 40}}>
                        ...
                        <TouchableOpacity style={{ gap: 4, justifyContent: 'center', alignItems: 'center'}}>
                            <Image source={voiceButton} style={{width: 48, height: 48}} />
                            <Text style={{fontSize: 13, fontWeight: '400', color: '#828282'}}>음성녹음</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
...
const styles = StyleSheet.create({
    ...
    chatInfoWrapper: { flexDirection: 'row', marginTop: 'auto', justifyContent: 'center', alignItems: 'center', gap: 4, marginRight: 4 }
})
